    ...
    <div className="bg-slate-50 pt-6 px-4 md:px-24  ">
      ...
      <div className="mx-auto w-full lg:w-[1180px] border border-gray-200 rounded-md overflow-hidden">
        <section className="flex flex-col lg:flex-row bg-white shadow-md">
          ...
          <article className="relative w-full lg:w-[320px] min-h-[150px]  h-auto  lg:h-[306px] flex-shrink-0">
            <img
              src={hero.imageSrc}
              alt={hero.imageAlt}
              className="absolute inset-0 w-full h-full object-cover lg:block "
              // Fallback for image loading errors
              onError={(e) => { e.target.onerror = null; e.target.src = "https://placehold.co/320x300/a0aec0/ffffff?text=Image+Not+Found"; }}
            />
            ...
            <div className="relative z-10 p-6 flex flex-col h-full">
              ...
              <button className="bg-white text-gray-800 px-4 py-2 rounded-md font-semibold hover:bg-gray-100 transition duration-300 self-start" onClick={handleSourceNowClick} >
                {hero.buttonText}
              </button>
            </div>
          </article>
            ...
            {products.map((item, index) => (
              ...
              >
                ...
                <img
                  ...
                  // Fallback for image loading errors
                  onError={(e) => { e.target.onerror = null; e.target.src = "https://placehold.co/64x64/d1d5db/000000?text=No+Img"; }}
                />
              </div>
            ))}
          </article>
